...
Shared assets for the Vanguard Cloud Consulting organisation profile.

| Path | Contents |
|---|---|
| `profile/assets/header.png` | Logo and wordmark banner used at the top of the organisation profile |
